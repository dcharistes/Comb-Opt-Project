...
# 1. Load the Model
filename = "0.txt"
model, ub, lb, integer_var, num_vars, c, arc_list, arc_to_idx = pg.gvrp_model_gurobi(filename)
...
start = time.time()
# 3. Run B&B
solutions, best_idx, count, nodes = bb.branch_and_bound(
